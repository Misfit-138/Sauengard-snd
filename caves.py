...
class PlayerSprite(arcade.Sprite):
    ...
    def __init__(self):
        ...
        texture = arcade.load_texture("telengard.png")
        self.textures.append(texture)
        texture = arcade.load_texture("telengard.png", flipped_horizontally=True)
        self.textures.append(texture)
        ...
        if not MERGE_SPRITES:
            ...
            for row in range(dg.height):
                for column in range(dg.width):
                    ...
                    if value == '#':
                        wall = arcade.Sprite("walls.png", WALL_SPRITE_SCALING)
